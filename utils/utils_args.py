...
def parse_args_uncond():
    ...
    parser.add_argument('--wandb', action='store_true', default=False, help='use wandb logger')
    parser.add_argument('--wandb_project', type=str, default='ImagenFew', help='wandb project name')
