...
class DiTwDDTHeadRectangle(nn.Module):
    def __init__(
            self,
            input_size: Union[int, list],
            patch_size: Union[list, int] = 1,
            in_channels: int = 768,
            hidden_size=[1152, 2048],
            depth=[28, 2],
        ...
        self.x_grid_size = self.x_embedder.grid_size
        self.s_grid_size = self.s_embedder.grid_size
