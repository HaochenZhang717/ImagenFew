...
# ==========================
NUM_GPUS=2
CONFIG="DiTDH-S-synth_u.yaml"

IMAGE_PATH="/playpen/haochenz/LitsDatasets/128_len_img_one_per_channel/istanbul_traffic/train"
RESULTS_DIR="/playpen/haochenz/ckpts_diffusion_prior_0306/istanbul_traffic"
NUM_CH=1
...
CMD="torchrun --master_port=29644 --nproc_per_node=${NUM_GPUS} train.py \
  --config ${CONFIG} \
