...
# ==========================
NUM_GPUS=2
CONFIG="DiTDH-S-stock.yaml"

IMAGE_PATH="/playpen/haochenz/LitsDatasets/128_len_img_one_per_channel/stock/train"
RESULTS_DIR="/playpen/haochenz/ckpts_diffusion_prior_0306/stock"
NUM_CH=6
...
CMD="torchrun --master_port=29664 --nproc_per_node=${NUM_GPUS} train.py \
  --config ${CONFIG} \
