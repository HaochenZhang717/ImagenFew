...
IMAGE_PATH="/playpen/haochenz/LitsDatasets/128_len_img_one_per_channel/synth_u/train"
RESULTS_DIR="/playpen/haochenz/ckpts_diffusion_prior_0306/synth_u"
NUM_CH=1
...
CMD="torchrun --master_port=29648 --nproc_per_node=${NUM_GPUS} train.py \
  --config ${CONFIG} \
