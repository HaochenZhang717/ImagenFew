python scripts_eval/evaluate_saved_eval_samples.py \
  ...
  --output-json "./ImagenTime_istanbul.json" \
  --output-csv "./ImagenTime_istanbul.json"
...
python scripts_eval/evaluate_saved_eval_samples.py \
  ...
  --eval-metrics disc vaeFID \
  --fid-vae-ckpt-root /playpen-shared/haochenz/ImagenFew/fid_vae_ckpts \
  --output-json "./ImagenTimeVecCond_istanbul.json" \
  --output-csv "./ImagenTimeVecCond_istanbul.json"
