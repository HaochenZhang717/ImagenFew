python scripts_eval/evaluate_saved_eval_samples.py \
  ...
  --output_json "./ImagenTime_istanbul.json" \
  --output_csv "./ImagenTime_istanbul.json"
...
python scripts_eval/evaluate_saved_eval_samples.py \
  ...
  --eval-metrics disc vaeFID \
  --fid-vae-ckpt-root /playpen-shared/haochenz/ImagenFew/fid_vae_ckpts \
    --output_json "./ImagenTimeVecCond_istanbul.json" \
  --output_csv "./ImagenTimeVecCond_istanbul.json"
