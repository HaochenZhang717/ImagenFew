CONDA_ENV=vlm sbatch --export=ALL,DATASET=ettm1_ve,NPROC_PER_NODE=2 slurm_stage1.sh
#CONDA_ENV=vlm sbatch --export=ALL,DATASET=ettm1,NPROC_PER_NODE=2 slurm_stage1.sh
