...
case "${DATASET}" in
  ettm1|ETTm1)
    DATASET_NAME="ETTm1"
    CHECKPOINT="${CHECKPOINT:-${REPO_ROOT}/caption_generator/logs/caption_generator/ettm1_stage1_qwen25_3b/joint_caption_best.pt}"
  ...
  synthetic_m)
    ...
    CHECKPOINT="${CHECKPOINT:-${REPO_ROOT}/caption_generator/logs/caption_generator/synthetic_m_stage1_qwen25_3b/joint_caption_best.pt}"
  ...
  synthetic_u)
    ...
    CHECKPOINT="${CHECKPOINT:-${REPO_ROOT}/caption_generator/logs/caption_generator/synthetic_u_stage1_qwen25_3b/joint_caption_best.pt}"
  ...
  istanbul|istanbul_traffic)
    ...
    CHECKPOINT="${CHECKPOINT:-${REPO_ROOT}/caption_generator/logs/caption_generator/istanbul_stage1_qwen25_3b/joint_caption_best.pt}"
  ...
  blindways|BlindWays)
    ...
    CHECKPOINT="${CHECKPOINT:-${REPO_ROOT}/caption_generator/logs/caption_generator/blindways_stage1_qwen25_3b/joint_caption_best.pt}"
  ...
  weather|Weather)
    ...
    CHECKPOINT="${CHECKPOINT:-${REPO_ROOT}/caption_generator/logs/caption_generator/weather_stage1_qwen25_3b/joint_caption_best.pt}"
