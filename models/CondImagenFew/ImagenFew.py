...
class CondImagenFew(nn.Module):
    ...
    def loss_fn(self, x, mask, class_indicies, num_classes):
        '''
        ...
        output, weight = self.forward(x * mask, labels = labels)
    ...
    def forward(self, x, mask, labels=None, augment_pipe=None):
