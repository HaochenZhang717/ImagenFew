#!/usr/bin/env bash
#SBATCH --job-name=verbalts_synthm
...
export WANDB_NAME="${WANDB_NAME:-synth-m_text2ts_msmdiffmv}"

echo "Running VerbalTS synth-m training on host $(hostname)"
...
CMD=(
  ...
  --save_folder ./logs/synth-m/text2ts_msmdiffmv
