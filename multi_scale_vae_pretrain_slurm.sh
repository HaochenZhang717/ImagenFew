...
CONFIG="${CONFIG:-./configs/pretrain/vae_pretrain_one_token.yaml}"
WANDB_PROJECT="${WANDB_PROJECT:-MultiScaleVAE}"
SUBSET_P="${SUBSET_P:-1.0}"

echo "Running MultiScaleVAE pretrain on host $(hostname)"
