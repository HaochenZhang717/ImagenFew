...
CONFIG="${CONFIG:-$ROOT_DIR/configs/self_cond_eval/AirQuality.yaml}"
SPLIT="${SPLIT:-train}"
SAMPLE_SOURCE="${SAMPLE_SOURCE:-prior}"
CONDITIONAL_CKPT="${CONDITIONAL_CKPT:-/playpen-shared/haochenz/ImagenFew/logs/self_conditional_generator/finetune/AirQuality/10d276e1-fdef-48a2-979c-110941f3d37b/conditional_generator.pt}"
PRIOR_CKPT="${PRIOR_CKPT:-/playpen-shared/haochenz/ImagenFew/logs/diffusion_prior/dit1d_base_finetune/AirQuality/diffusion_prior_latest.pt}"
