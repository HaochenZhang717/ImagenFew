...
CMD=(
  ...
  --save_folder ./logs/ettm1/text2ts_msmdiffmv
  --model_diff_config_path configs/ettm1/diff/model_text2ts_dep.yaml
  --model_cond_config_path configs/ettm1/cond/text_msmdiffmv.yaml
  --train_config_path configs/ettm1/train.yaml
  --evaluate_config_path configs/ettm1/evaluate.yaml
  --data_folder ../data/VerbalTSDatasets/ETTm1
  --clip_folder ""
  --multipatch_num 3
  --L_patch_len 3
  --base_patch 4
