...
export MASTER_PORT="${MASTER_PORT:-29676}"
export CUDA_VISIBLE_DEVICES="${CUDA_VISIBLE_DEVICES:-0}"
export TOKENIZERS_PARALLELISM=false

CONFIG="${CONFIG:-$ROOT_DIR/diffusion_prior/configs/dit1d_simple_vae.yaml}"

echo "Running 1-GPU Slurm DiT1D diffusion prior for SimpleVAE latents on host $(hostname)"
